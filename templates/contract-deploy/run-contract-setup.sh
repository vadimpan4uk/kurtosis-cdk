...
MNEMONIC="{{.l1_preallocated_mnemonic}}" npx ts-node deployment/v2/1_createGenesis.ts --predefined='[{"isContract": false,"name": "admin","balance": "1000000000","address": "0x02d655B0396e40dA9fD80C0528f9C3fb488895Df"}]' | tee 02_create_genesis.out
